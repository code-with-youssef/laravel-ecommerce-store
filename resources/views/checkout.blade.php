        ...
        <div class="row">
                        ...
                        <tbody>
                            @foreach ($userCart->cartItems as $cartItem)
                                <tr>
                                    ...
                                    <td>{{ number_format($cartItem->product->price, 2) }} LE</td>
                                    <td>{{ $cartItem->quantity }}</td>
                                    <td>{{ number_format($cartItem->product->price * $cartItem->quantity, 2) }} LE</td>
                                </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
                            <tr>
                                ...
                                <th>{{ number_format($total, 2) }} LE</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <th>{{ number_format($total + 45, 2) }} LE</th>
                            </tr>
                        </tfoot>
                    </table>
                </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="checkout-form">
                    ...
                    method="POST" 
                    id="checkoutForm" 
                    data-cod-action="{{ route('order.add') }}" 
                    data-credit-action="{{ route('payment.process') }}"
                    >
                        @csrf
