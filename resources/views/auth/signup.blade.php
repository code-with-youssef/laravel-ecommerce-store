        ...
        <div class="contact-form">
            <form action="{{ route('register') }}" method="POST" id="fruitkha-contact" onsubmit="return valid_datas(this);">
                ...
                <div class="form-group mb-3">
                    <input type="text" class="form-control allow-select custom-input" placeholder="Name" name="name" id="name" value="{{ old('name') }}" required>
                    @error('name')
                ...
                <div class="form-group mb-4">
                    <input type="password" class="form-control allow-select custom-input" placeholder="Confirm Password" name="password_confirmation" id="password_confirmation" required>
                    @error('password_confirmation')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>

                <p>already have an account? <a href="{{route('login.index')}}" style="color:#3180a5">Login</a></p>
