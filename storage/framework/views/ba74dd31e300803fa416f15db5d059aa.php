        ...
        <div class="profile-col">
            <div class="profile-card">
                ...
                <div class="profile-header">
                    ...
                    <div class="profile-img-container">
                        <div class="profile-img-wrapper">
                            <img src="<?php echo e(url($currentUser->imagepath)); ?>" alt="User Avatar" class="profile-avatar">
                ...
                <div class="profile-content">
                    <h3 class="profile-name"><?php echo e($currentUser->name); ?></h3>
                    <p class="profile-email">
                        <i class="fas fa-envelope email-icon"></i><?php echo e($currentUser->email); ?>
                    ...
                    <div class="profile-stats">
                        <div class="stat-item">
                            ...
                            <p class="stat-number"><?php echo e($currentUser->orders->count()); ?></p>
                        </div>
